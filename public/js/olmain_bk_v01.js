...
//  2. ol.layer.Image: Renders sources that provide map images at arbitrary extents and resolution.
...
var tiled_osm_layer = new ol.layer.Tile({
    source: new ol.source.OSM()
});

// Create the required maps with image geo object
const house_layer = new ol.layer.Image({
...
var parcel_layer = new ol.layer.Image({
    source: new ol.source.ImageWMS({
        ratio: 1,
        url: 'http://localhost:9999/geoserver/WebGISDBdev/wms',
        params: {
...
var street_layer = new ol.layer.Image({
    source: new ol.source.ImageWMS({
        ratio: 1,
        url: 'http://localhost:9999/geoserver/WebGISDBdev/wms',
        params: {
...
var streetline_layer = new ol.layer.Image({
    source: new ol.source.ImageWMS({
        ratio: 1,
        url: 'http://localhost:9999/geoserver/WebGISDBdev/wms',
        params: {
...
var tree_layer = new ol.layer.Image({
    source: new ol.source.ImageWMS({
        ratio: 1,
        url: 'http://localhost:9999/geoserver/WebGISDBdev/wms',
        params: {
...
const group_layer = new ol.layer.Image({
    source: new ol.source.ImageWMS({
        ratio: 1,
        url: 'http://localhost:9999/geoserver/WebGISDBdev/wms',
        params: {
...
const view = new ol.View({
    ...
    center: ol.proj.fromLonLat([106.8379, 10.85]),
    zoom: 16,
});
    ...
    xmlhttp.onreadystatechange = function () {
        if (xmlhttp.readyState == XMLHttpRequest.DONE) {
            ...
            var vectorSource = new ol.source.Vector({
                features: (new ol.format.GeoJSON()).readFeatures(njsdata)
            });
...
function FindLocation(x, y, longitude, latitude){
