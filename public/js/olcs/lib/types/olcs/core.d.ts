 ...
 */
export declare function convertColorToCesium(olColor: ColorLike | OLColor | PatternDescriptor | CanvasGradient | CanvasPattern | string): Color | ImageMaterialProperty;
/**
